...
{
    public abstract class TimeSpanExtensionTest
    {
    ...
    public class when_timespan_is_zero :TimeSpanExtensionTest
    {
        [Fact]
    ...
    public class hour_segment_tests : TimeSpanExtensionTest
    {
        [Fact]
    ...
    public class minute_segment_tests : TimeSpanExtensionTest
    {
        [Fact]
    ...
    public class seconds_segment_tests : TimeSpanExtensionTest
    {
        [Fact]
    ...
    public class composite_tests : TimeSpanExtensionTest
    {
        [Fact]
